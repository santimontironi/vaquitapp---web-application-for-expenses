...
const Register = () => {
  ...
  return (
    <main className="relative min-h-screen bg-[#0F172A] flex items-center justify-center py-5 md:py-6 xl:py-10 2xl:py-15 px-4 overflow-hidden">
      ...
      <div className="absolute top-20 right-20 rounded-full bg-[#3B82F6] w-20 h-20 blur-3xl pointer-events-none"></div>
      <div className="absolute bottom-20 left-20 rounded-full bg-[#3B82F6] w-20 h-20 blur-3xl pointer-events-none"></div>

      <section className="relative z-10 w-full max-w-sm md:max-w-md">

        <div className="flex flex-col items-center mb-8 gap-4">
          <div className="relative">
            <div className="absolute inset-0 rounded-full bg-[#3B82F6]/25 blur-3xl scale-[2.4] pointer-events-none" />
          ...
          <div className="flex flex-col items-center gap-1">
            <h1 className="text-white drop-shadow-[0_0_18px_rgba(59,130,246,0.45)]">
              VaquitApp
            </h1>
        ...
        <div className="relative p-px rounded-3xl bg-linear-to-br from-[#3B82F6]/45 via-white/5 to-[#10B981]/30 shadow-[0_0_60px_rgba(59,130,246,0.10),0_25px_60px_rgba(0,0,0,0.6)]">
          ...
          <div className="relative bg-[#0A1020]/85 backdrop-blur-3xl rounded-[23px] p-6 md:p-9 overflow-hidden">
            ...
            <h2 className="text-white mb-1">Registrarse</h2>

            <div className="flex items-center gap-3 mb-7">
              <div className="h-px flex-1 bg-linear-to-r from-[#3B82F6]/35 to-transparent" />
              <div className="flex gap-1">
                <div className="w-1 h-1 rounded-full bg-[#3B82F6]/60" />
                <div className="w-1 h-1 rounded-full bg-[#10B981]/40" />
              </div>
              <div className="h-px flex-1 bg-linear-to-l from-[#10B981]/20 to-transparent" />
            </div>
            ...
            <form onSubmit={handleSubmit(submitForm)} noValidate className="flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-2">
                <label htmlFor="username" className="text-white/55">
                  Nombre de usuario
                </label>
              ...
              <div className="flex flex-col gap-2">
                <label htmlFor="email" className="text-white/55">
                  Email
                </label>
                <div className="relative group/field">
                  <div className={[
              ...
              <div className="relative group/btn">
                ...
                <button
                  ...
                  className={[
                    ...
                    "active:shadow-[0_2px_12px_rgba(59,130,246,0.25)]",
                    "disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:shadow-[0_4px_24px_rgba(59,130,246,0.30)]",
                  ].join(" ")}
                >
