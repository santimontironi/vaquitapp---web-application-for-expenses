...
import type { CreateExpenseData, CreateExpenseResponse, GetExpensesResponse } from "../types/expense.types";
...
export const completeExpenseService = (idGroup: string, idPlan: string, idExpense: string) => {
    return api.patch(`/groups/${idGroup}/plans/${idPlan}/expenses/${idExpense}/complete`);
};
