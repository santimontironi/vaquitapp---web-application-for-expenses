...
const MemberItem = ({ member, onDeleteMember }: MemberItemProps) => {
  ...
  return (
    <div className={`group flex items-center gap-4 px-4 py-3 rounded-xl bg-white/3 border border-white/6 ${hoverBorder} hover:bg-white/6 hover:-translate-y-px hover:shadow-[0_4px_16px_rgba(0,0,0,0.35)] transition-all duration-200 cursor-default`}>
