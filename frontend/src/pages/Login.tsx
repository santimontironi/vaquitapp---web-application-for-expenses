...
const Login = () => {
  ...
  return (
    <main className="relative min-h-screen bg-[#0F172A] flex items-center justify-center py-5 md:py-6 xl:py-10 2xl:py-15 px-4 overflow-hidden">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-150 h-75 rounded-full bg-[#10B981]/6 blur-[130px] pointer-events-none" />
      <div className="absolute top-[-5%] right-[-8%] w-96 h-96 rounded-full bg-[#10B981]/8 blur-[100px] pointer-events-none" />
      <div className="absolute bottom-[-8%] left-[-6%] w-80 h-80 rounded-full bg-[#3B82F6]/7 blur-[110px] pointer-events-none" />
      <div className="absolute top-1/2 left-[-10%] w-64 h-64 rounded-full bg-[#10B981]/4 blur-[90px] pointer-events-none" />
      <div className="absolute bottom-[10%] right-[5%] w-72 h-72 rounded-full bg-[#3B82F6]/5 blur-[120px] pointer-events-none" />
      <div className="absolute top-[30%] right-[-5%] w-48 h-48 rounded-full bg-[#10B981]/5 blur-[80px] pointer-events-none" />
